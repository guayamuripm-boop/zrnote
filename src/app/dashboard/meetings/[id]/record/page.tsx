      ...
      {meeting?.status !== 'processing' && (
        <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 max-w-2xl mx-auto">
          ...
          <div className="glass-strong rounded-2xl p-4 sm:p-5 text-center">
            ...
            <p className="text-sm font-medium text-slate-900 dark:text-slate-100">Pantalla bloqueada</p>
            <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">Sigue grabando con la pantalla apagada</p>
          </div>
          <div className="glass-strong rounded-2xl p-4 sm:p-5 text-center">
